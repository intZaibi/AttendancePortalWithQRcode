...
export default function Navbar() {
  ...
  return (
    <>
      {!isAdminPage && (
        <div className={`lg:block fixed md:hidden right-0 lg:left-0 transition-all duration-300 ease-in-out transform ${menu ? 'translate-x-0 opacity-100' : 'translate-x-[200%] opacity-0 lg:translate-x-0 lg:opacity-100'}`}>
          <Sidebar />
        </div>
      )}
